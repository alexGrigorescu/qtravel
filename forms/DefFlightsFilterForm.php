<?php
	class DefFlightsFilterForm extends Form
	{
		function DefFlightsFilterForm($obj)
		{
			$this->setMethod('GET');
		
			$this->setName('flights');
			$this->setPrefix('flights_filter_');
			$this->setPrefixLang('flights_');
			...
			$e->options = array(0=>tr('flights_label_any_continent'));
			...
			$e->options = array(0=>tr('flights_label_any_country'));
			...
			$e->options = array(0=>tr('flights_label_any_region'));
			...
			$e->options = array(''=>tr('flights_label_any_special1'), '1'=>tr('flights_label_special1_yes'), '0'=>tr('flights_label_special1_no'));
			$this->addElement($e);
			
			$e = new FormElementCombobox('special2');
			$e->options = array(''=>tr('flights_label_any_special2'), '1'=>tr('flights_label_special2_yes'), '0'=>tr('flights_label_special2_no'));
			$this->addElement($e);
