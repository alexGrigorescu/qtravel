...
function drawColorPicker()
	...
	var sHTMLColor="<table id=dropColor"+this.oRenderName+" style=\"width:143px; height:109px; z-index:1;display:none;position:absolute;border:#9b95a6 1px solid;cursor:default;background-color:#E9E8F2;padding:2px\" unselectable=on cellpadding=0 cellspacing=0><tr><td unselectable=on>"
	...
	for(var i=0;i<arrColors.length;i++)
		...
		for(var j=0;j<arrColors[i].length;j++)
			sHTMLColor+="<td onclick=\""+this.oName+".color='"+arrColors[i][j]+"';"+this.oName+".onPickColor();"+this.oName+".currColor='"+arrColors[i][j]+"';"+this.oName+".hideAll()\" onmouseover=\"this.style.border='#777777 1px solid'\" onmouseout=\"this.style.border='#E9E8F2 1px solid'\" style=\"cursor:default;padding:1px;border:#E9E8F2 1px solid; width:13px;height:13px;\" unselectable=on>"+
