...
<a href="{url o='vacation' m='continent' continent=$continent.code}">{$continent.title}</a>
...
{if $continent.description > ''}
	<div style="margin:5px;">	
		<div>
			<h3 class="continent">{tr key="vacation_title_continent_description"}  {$continent.title}</h3>
