<?php /* Smarty version 2.6.18, created on 2011-07-31 21:11:51
         compiled from /home/qtravel/public_html/systems/q-travel/templates/member/layout.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'tr', '/home/qtravel/public_html/systems/q-travel/templates/member/layout.tpl', 21, false),array('function', 'url', '/home/qtravel/public_html/systems/q-travel/templates/member/layout.tpl', 21, false),array('modifier', 'nl2br', '/home/qtravel/public_html/systems/q-travel/templates/member/layout.tpl', 143, false),)), $this); ?>
...
cauta.jpg" />
			...
			<div class="header-contact header-contact-<?php echo $this->_tpl_vars['header']; ?>
">
				<table style="width:200px;">
					<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;021 310 00 15</td></tr>
					<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;021 310 31 51</td></tr>
					<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;031 100 59 30</td></tr>
					<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;031 100 59 29(fax)</td></tr>
					<tr><td>Str. Caderea Bastiliei, <br/>Nr. 66, Sct 1, Bucuresti</td></tr>
				</table>
			</div>
		    </div>
		</div>
...
blue_bullet.jpg" />                    
		...
		<?php if ($this->_tpl_vars['layout_domain']['code'] == 'oferta-vacanta'): ?>
                <div class="clear"></div>
		<div class="regiuni">
			<div class="regiuni_header2"></div>
			<ul>
				<?php $_from = $this->_tpl_vars['GLOBALS']['ACCOMCAT_ACTIVE']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['acc_code'] => $this->_tpl_vars['acc']):
?>
					<li><div class="divli"><a href="/<?php echo $this->_tpl_vars['acc_code']; ?>
.html" title="<?php echo $this->_tpl_vars['acc']; ?>
			...
			<div class="newsletter">
				<div class="newsletter-form">
						...
						<div class="newsletter-input">
							<input type="" id="newsletter_name"/>
						</div>
						<div class="newsletter-label">
							E-mail:
						</div>
						<div class="newsletter-input">
							<input type="" id="newsletter_email"/>
						</div>
						<div class="newsletter-error" id="newsletter-error"></div>
				</div>
				<div class="newsletter-button"><input type="image" src="<?php echo $this->_tpl_vars['img_path']; ?>
newsletter-trimite.png" onClick="newsletter();"/></div>                	
				<script language="javascript">
					<?php echo '
					function newsletter()
							{
								var url = "'; ?>
<?php echo smarty_function_url(array('o' => 'newsletter','m' => 'save'), $this);?>
<?php echo '";
...
someone.png" /></div>
	                <div class="stats"><?php echo $this->_tpl_vars['layout_domain']['stats']; ?>
</div>
	            </div>             
            </div>
