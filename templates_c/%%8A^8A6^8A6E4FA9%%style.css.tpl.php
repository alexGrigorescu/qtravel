<?php /* Smarty version 2.6.18, created on 2013-02-07 17:26:47
         compiled from /home/qtravel/public_html/systems/oferta-vacanta/templates/member/style.css.tpl */ ?>
<?php echo '	
html { 
	height: 100%; }
body { 
...
#page-header #contact-zone {
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/contact_bg.png"); }
#page-header #contact-zone #logo {
	position:absolute; 
	margin:0px 0px 0px 3px; }
#detail-flight-pictures .left img {width:150px;height:100px; }
...
#page-header #submenu-vacancies #container { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/submenu_vacancies.png"); }
...
#page-header li#submenu-tickets { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_tickets.png"); }
#page-header li#submenu-tickets:hover { 
	width: 74px;		
	height:95px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_tickets_h.png"); }
...
#page-header li#submenu-tour { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_tour.png"); }
#page-header li#submenu-tour:hover { 
	width: 86px;		
	height:95px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_tour_h.png"); }
...
#page-header li#submenu-events { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_events.png"); }
#page-header li#submenu-events:hover { 
	width: 119px;		
	height:95px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_events_h.png"); }
...
#page-header li#submenu-contact { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_contact.png"); }
#page-header li#submenu-contact:hover { 
	width: 90px;		
	height:95px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_contact_h.png"); }
/*end menu*/
#page-header{ 
	width:975px; 
	height:386px;
...
#page #bubles #buble-back li.back-active { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_back_active.png"); }
#page #bubles #buble-back li.back-active:hover { 
	width: 32px;		
	height:53px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_back_h.png"); }
#page #bubles #buble-back li.back-inactive { 
	width: 32px;		
	height:53px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_back_inactive.png"); }
...
#page #bubles #buble-next li.next-active { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_next_active.png"); }
#page #bubles #buble-next li.next-active:hover { 
	width: 32px;		
	height:53px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_next_h.png"); }
#page #bubles #buble-next li.next-inactive { 
	width: 32px;		
	height:53px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_next_inactive.png"); }
#page #bubles a{ 
	text-decoration:none; }
...
#page #page-body #body-engine-full{
	margin:0px 0px 0px 0px;
	width:975px;
	float:left;
	background: url('; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/result_bg_full.png) no-repeat;
	background-color:#22246a; }
#page #page-body #body-engine-full-height{
	margin:0px 0px 0px 0px;
	width:675px;
	float:left;
	background: url('; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/result_bg_full.png)repeat-y;
	background-color:#22246a; }
...
#page #search #search-buttons li.btn-search-plane-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_plane.png"); }
#page #search #search-buttons li#btn-search-plane:hover { 
	width: 170px;		
	height:44px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_plane_h.png"); }
...
#page #search #search-buttons li.btn-search-bus-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_bus.png"); }
#page #search #search-buttons li#btn-search-bus:hover { 
	width: 170px;		
	height:64px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_bus_h.png"); }
...
#page #search #search-buttons li.btn-search-vacancies-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_vacancies.png"); }
#page #search #search-buttons li#btn-search-vacancies:hover { 
	width: 170px;		
	height:44px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_vacancies_h.png"); }
...
#page #search #search-buttons li.btn-search-hotels-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_hotels.png"); }
#page #search #search-buttons li#btn-search-hotels:hover { 
	width: 170px;		
	height:44px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_hotels_h.png"); }
...
#page #search #search-buttons li.btn-search-rentcar-inactive  { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_rentcar.png"); }
#page #search #search-buttons li#btn-search-rentcar:hover { 
	width: 170px;		
	height:44px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_rentcar_h.png"); }
...
#page #search #search-buttons li.btn-search-insurance-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_insurance.png"); }
#page #search #search-buttons li#btn-search-insurance:hover { 
	width: 170px;		
	height:44px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_search_insurance_h.png"); }
...
#page #search-external-hotel { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/search_external_hotel_bg.png"); }
...
#page #right_advertising_bg { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/right_advertising_bg.png"); }
...
#page #promo-container #promo-header li.last-minute-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_last_minute.png"); }
#page #promo-container #promo-header li.last-minute-active { 
	width: 106px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_last_minute_h.png"); }
...
#page #promo-container #promo-header li.early-booking-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_early_booking.png"); }
#page #promo-container #promo-header li.early-booking-active { 
	width: 123px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_early_booking_h.png"); }
...
#page #promo-container #promo-header li.easter-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_easter.png"); }
#page #promo-container #promo-header li.easter-active { 
	width: 56px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_easter_h.png"); }
...
#page #promo-container #promo-header li.first-may-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_first_may.png"); }
#page #promo-container #promo-header li.first-may-active { 
	width: 45px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_first_may_h.png"); }
...
#page #promo-container #promo-header li.seaside-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_seaside.png"); }
#page #promo-container #promo-header li.seaside-active { 
	width: 68px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_seaside_h.png"); }
...
#page #promo-container #promo-header li.ski-inactive { 
	width: 40px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_ski.png"); }
#page #promo-container #promo-header li.ski-active { 
	width: 40px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_ski_h.png"); }
#page #promo-container #promo-header li#ski:hover { 
	width: 40px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_ski_h.png"); }
#page #promo-container #promo-header li.noel-inactive { 
	width: 79px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_noel.png"); }
#page #promo-container #promo-header li.noel-active { 
	width: 79px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_noel_h.png"); }
#page #promo-container #promo-header li#noel:hover { 
	width: 79px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_noel_h.png"); }
#page #promo-container #promo-header li.new_year_eve-inactive { 
	width: 85px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_new_year_eve.png"); }
#page #promo-container #promo-header li.new_year_eve-active { 
	width: 85px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_new_year_eve_h.png"); }
#page #promo-container #promo-header li#new_year_eve:hover { 
	width: 85px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_new_year_eve_h.png"); }
#page #promo-container #promo-header li.spa_balneo-inactive { 
	width: 106px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_spa_balneo.png"); }
#page #promo-container #promo-header li.spa_balneo-active { 
	width: 106px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_spa_balneo_h.png"); }
#page #promo-container #promo-header li#spa_balneo:hover { 
	width: 106px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
...
#page #promo-container #promo-header li.seniors-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_seniors.png"); }
#page #promo-container #promo-header li.seniors-active { 
	width: 67px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_seniors_h.png"); }
...
#page #promo-container #promo-header li.mountain-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_mountain.png"); }
#page #promo-container #promo-header li.mountain-active { 
	width: 59px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_mountain_h.png"); }
...
#page #promo-container #promo-header li.events-inactive { 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_events.png"); }
#page #promo-container #promo-header li.events-active { 
	width: 102px;		
	height:29px;		
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_promo_events_h.png"); }
...
#page #promo-container #promo-body #promo-offers div.regular-buble {
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/promo_regular_buble.png");
	text-align:center; }
...
#promo-accordion{
	border:0;}
#promo-accordion #promo-body{ 
	margin:0px 0px 0px 0px;
	width:auto;
	height:auto;
	text-align:left;}
#promo-accordion #promo-body #promo-offers{ 
	margin:0 0 20px;
	padding-bottom:20px;
	width:auto;
	height:auto;
...
#promo-accordion #promo-body #promo-offers ul {
	margin:0px 0px 0px -27px;
	width:auto;
	height:auto;
	text-align:left; }
#promo-accordion #promo-body #promo-offers li {
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/promo_accordion_item_bg.png"); }
#promo-accordion #promo-body #promo-offers div.promo-item-container {
	margin:0px 0px 0px 0px;
	float:left;
	width:174px;
	height:90px;
	...
	border-top-right-radius: 6px;
	overflow:hidden; }
#promo-accordion #promo-body #promo-offers div.promo-text-container {
	margin:0px 0px 0px 0px;
	float:left;
	width:174px;
	height:55px; }
#promo-accordion #promo-body #promo-offers div.promo-text-container .promo-title-violet{
	position:relative;
	margin:0px 0px 0px 15px;
	font-family:"Arial";
	font-size:12pt;
	...
	width:100px;
	height:30px; }
#promo-accordion #promo-body #promo-offers div.promo-text-container .promo-text-violet{
	position:relative;
	margin:0px 0px 0px 15px;
	font-family:"Arial";
	font-size:10pt;
	...
	width:150px; 
	height:170px; }
#promo-accordion #promo-body #promo-offers div.regular-buble {
	position:absolute;
	margin:60px 0px 0px 115px;
	width:59px;
	height:70px;
...
<?php echo '/promo_regular_buble.png");
	text-align:center; }
#promo-accordion #promo-body #promo-offers div.regular-buble span{
	font-family:"Arial";
	font-size:20pt;
	color:#ffffff;
	font-weight:bold; 
...
#page #promo-container #promo-footer #promo-slider-inactive{ 
	...
	background: url('; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/promo_slider_inactive2.png) no-repeat;
	visibility:hidden;
}
/*end promotions*/
...
#page #facebook-container.cleared-zone { 
	position:relative; 
	margin:0px 0px 0px 0px;
	width:300px;
	height:375px;
...
#accordion-home-mkt h2{
	...
	font-size:15pt;}
/*accordion*/
#accordion-home-promo { border: 1px solid #111 !important; }
#accordion-home-promo div.selected .title { font-weight: bold !important; }
#accordion-home-promo div div.title {
	border:0 !important;
	background:none !important;
	background-color: #2e3192 !important;}
#accordion-home-promo div.title {
	border: 0 !important;
	background-color: #2e3192 !important;
	padding: 10px !important;
	cursor: pointer !important;
	text-align:left;}
#accordion-home-promo div.selected {
	border-bottom: none !important;}
#accordion-home-promo .ui-state-default,#accordion-home-promo .ui-corner-all,#accordion-home-promo .ui-widget-content .ui-state-default,#accordion-home-promo .ui-widget-header .ui-state-default{
	-moz-border-radius: 0px;
	-webkit-border-radius: 0px;
	-khtml-border-radius: 0px;
	border-radius: 0px;}
#accordion-home-promo .ui-corner-all,#accordion-home-promo .ui-corner-bottom,#accordion-home-promo .ui-corner-left,#accordion-home-promo .ui-corner-bl{
	-moz-border-radius: 0px;
	-webkit-border-radius: 0px;
	-khtml-border-radius: 0px;
	border-radius: 0px;}
#accordion-home-promo .ui-icon{
	background:none !important;}
/*page search result*/
#page #page-body #body-engine-full,.result{
	background: url('; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/result_bg.png); }
#page #page-body #body-engine-full .result-header{
	position:relative; 
	margin:0px 0px 0px 0px;
	width:676px;
	height:90px;
	float:left; }
#page #page-body #body-engine-full .result-header .result-title {
	position:relative; 
	margin:0px 0px 0px 0px;
	width:676px;
	height:40px;
	float:left;
	text-align:left; }
#page #page-body #body-engine-full .result-header .result-title img{
	position:relative; 
	margin:15px 0px 0px 25px; }
#page #page-body #body-engine-full .result-top-paging {
	position:relative; 
	margin:0px 0px 0px 0px;
	width:676px;
	height:50px;
	float:left; }
#page #page-body #body-engine-full .result-top-paging .paging-container{
	position:relative; 
	...
	background: url('; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/result_paging_bg.png);}
#page #page-body #body-engine-full .result-top-paging .paging-container .page-back{
	position:relative; 
	margin:0px 0px 0px 0px;
	width:220px;
	height:24px;
	float:left; 
	text-align:left; }
#page #page-body #body-engine-full .result-top-paging .paging-container .page-back .breadcrumbs {
	position:relative; 
	margin:10px 5px 0px 10px;
	color:#fdce00;
	font-size:8pt; }
#page #page-body #body-engine-full .result-top-paging .paging-container .page-back .page-text {
	font-family:"Arial";
	font-size:8pt;
	color:#ffffff;
	font-weight:bold; 
	line-height:19px; }
#page #page-body #body-engine-full .result-top-paging .paging-container .page-middle{
	position:relative; 
	margin:0px 0px 0px 0px;
	width:180px;
	height:24px;
	float:left; }
#page #page-body #body-engine-full  .result-top-paging .paging-container .page-middle ul {
	margin:2px 0px 0px -36px;
	width:180px;
	height:24px; }
#page #page-body #body-engine-full .result-top-paging .paging-container .page-middle li {
	margin:0px 0px 0px 5px;
	width:20px;
	height:20px;
	float:left; }
#page #page-body #body-engine-full  .result-top-paging .paging-container .page-middle li.page-count {
	font-family:"Arial";
	font-size:8pt;
	color:#ffffff;
	font-weight:normal; 
	line-height:20px; }
#page #page-body #body-engine-full .result-top-paging .paging-container .page-middle li.selected {
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/result_page_count_bg.png");
	color:#383a7a; }
#page #page-body #body-engine-full .result-top-paging .paging-container .page-next{
	position:relative; 
	margin:0px 0px 0px 0px;
	width:224px;
	height:24px;
	float:left;
	text-align:right; }
#page #page-body #body-engine-full .result-top-paging .paging-container .page-next  .breadcrumbs{
	position:relative; 
	margin:10px 10px 0px 5px;
	color:#fdce00;
	font-size:8pt; }
#page #page-body #body-engine-full .result-top-paging .paging-container .page-next .page-text {
	font-family:"Arial";
	font-size:8pt;
	color:#ffffff;
	font-weight:bold; 
	line-height:19px; }
#page #page-body #body-engine-full .result-body{
	position:relative; 
	margin:0px 0px 0px 0px;
	width:676px;
	height:auto;
	...
	float:left;
	z-index:9996; }
#page #page-body #body-engine-full .result-body ul {
	margin:0px 0px 0px -64px;
	width:676px;
	height:auto;
	text-align:left; }
#page #page-body #body-engine-full .result-body li.hotels {
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/result_item_bg.png"); }
#page li.hotels-similar {
...
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/result_item_bg.png"); }
#page #page-body #body-engine-full .result-body li.towns {
	margin:40px 0px 0px 50px;
	float:left;
	width:174px;
	line-height:15px; }
#page #page-body #body-engine-full .result-body li.upper {
	margin:47px 0px 0px 50px; }
#page div.result-item-title {
	position:absolute;
	margin:-32px 0px 0px 0px;
	width:174px;
	height:20px; }
#page div.result-item-title span {
	font-family:"Arial";
	font-size:12pt;
	color:#4fa800;
	font-weight:bold; 
...
#page div.result-item-container {
	position:relative;
	margin:0px 0px 0px 0px;
	float:left;
	width:174px;
	...
	-khtml-border-top-right-radius: 6px; 
	border-top-right-radius: 6px;}
#page div.result-text-container-left {
	margin:0px 0px 0px 0px;
	float:left;
	width:78px;
	height:55px; }
#page div.result-text-container-middle {
	margin:0px 0px 0px 4px;
	float:left;
	width:76px;
	height:55px;
	text-align: right; }
#page div.result-text-container-right {
	margin:0px 0px 0px 0px;
	float:left;
	width:16px;
	height:55px; }
#page .result-promo-value{
	position:relative;
...
#page .result-promo-price{
	...
	font-weight:bold; 
	line-height:50px; }
#page .result-promo-lastoffer-container{
	padding:5px;
}
#page .result-promo-lastoffer{
	position:relative;
	margin:0px 0px 0px 0px;
	font-family:"Arial";
	font-size:10pt;
...
#page .result-promo-euro{
	...
	font-weight:bold; 
	line-height:51px; }
#page #page-body #body-engine-full .result-footer{
	position:relative; 
	margin:-10px 0px 0px 0px;
	width:676px;
	height:54px;
...
#page #continents-buttons span.continent-text{ 
	...
	font-weight:bold; 
	line-height:45px;  }
#page #continents-buttons ul.continent {
	margin:-2px 0px 0px -40px;
	width:300px;
	height:229px;
	text-align:left;
	z-index:9998; }
#page #continents-buttons li.continent {
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_continent.png");
	cursor:pointer; }
#page #continents-buttons li.continent:hover {
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_continent_s.png"); } 
#page #continents-buttons li.continent:hover .continent-text{color:#ffcb08;}
	#page #continents-buttons li.continent.selected-continent:hover {
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_continent_s.png"); }
#page #continents-buttons li.continent.selected-continent {
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/btn_continent_h.png"); }
...
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/right_advertising_bg.png"); }
#page #result-right-advertising-bg.cleared-zone { 
	position:relative; 
	margin:0px 0px 0px 0px;
	width:300px;
	height:auto;
...
#page #result-fast-search #fast-search-middle .left .fast-search-container{ 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/fast_search_left_bg.png"); }
...
#page #result-fast-search #fast-search-middle .right .fast-search-container{ 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/fast_search_right_bg.png"); }
...
#page #page-body #contact-header-text{ 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/contact_header_text.png");
	width:590px;
	height:103px; }
...
#page #page-body #contact-middle-text{ 
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/contact_middle_text.png");
	width:480px;
	height:47px; }
...
#page #page-body #detail-content{
	...
	float: left;
	overflow:hidden;} 
#page #page-body #detail-content-full-height{
	position:relative; 
	margin:30px 0px 0px 27px;
	width:621px;
	float: left;
...
#page #page-body #detail-title .left .bottom{
	...
	overflow:hidden;
	text-align:left;} 
#page #page-body #detail-title .left .top h1{
    color: #FFFFFF;
    font-family: "Arial";
    font-size: 20pt;
    font-weight: bold;
...
#page #page-body #detail-title .left .bottom span{
    ...
    font-weight: bold;
    line-height: 15px;}
#page #page-body #detail-title .left .offer-detail{
    color: green;
    font-family: "Arial";
    font-size: 12pt;
    font-style:italic;
...
#page #page-body #detail-pictures .left #detail-image-bg{
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/detail_primary_image_bg.png");
	position:relative; 
	margin:0px 0px 0px 0px;
	width:456px;
	height:347px;
...
#page #page-body #detail-pictures .right li{
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/detail_list_image_bg.png");
	position:relative; 
	margin:5px 0px 0px 0px;
	width:149px;
	height:112px; } 
...
#page #page-body #detail-hotel .left #text-container{
	position:relative; 
	margin:10px 0px 0px 0px;}	
#page #page-body #detail-hotel .left #text-container h2{
    color: #ffffff;
    font-family: "Arial";
    font-size: 12pt;
    font-weight: bold;
...
#page #page-body #detail-description{
	...
	text-align:left;
	overflow:auto;}
#page #page-body #detail-description-full{
	position:relative; 
	margin:0px 0px 0px 0px;
	width:621px;
	float: left;
...
#page #page-body .description-text{
    ...
    font-weight: bold;
    line-height: 15px;}
#page .description-text-page{
    color: #e2e2eb;
    font-family: "Arial";
    font-size: 10pt;
    font-weight: normal;
    line-height: 17px;}
#page .description-text-red{
    color: #d24329;
    font-family: "Arial";
    font-size: 10pt;
    font-weight: bold;
    line-height: 15px;}
#page .description-text-white{
    color: #ffffff;
    font-family: "Arial";
    font-size: 10pt;
    font-weight: bold;
...
#page #page-body #detail-buttons #detail-btn-details{
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/detail_btn_details.png");
	position:relative; 
	width:82px;
	height:30px;
	float:left; } 
#page #page-body #detail-buttons #detail-btn-tarif7{
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/detail_btn_tarif7.png");
	position:relative; 
	width:194px;
	height:30px;
	float:left; }
#page #page-body #detail-buttons #detail-btn-impresion{
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/detail_btn_impresion.png");
	position:relative; 
	width:82px;
	height:30px;
	float:left; }
...
#page #page-body #detail-similars img{
	...
	width:auto;/*621 100px cu 3 intre*/
	height:44px;
	float: left;}
#page #page-body #detail-similars img.back{
	position:relative; 
	margin:13px 0px 0px 0px;
	width:auto;
	height:44px;
	float: left;}
#page #page-body #detail-similars img.next{
	position:relative; 
	margin:13px 0px 0px 0px;
	width:auto;
	height:44px;
...
#page #detail-reservation-content {
	...
	float: left;
	overflow:hidden;} 
#page #detail-reservation-content-full {
	position:relative; 
...
#page #detail-reservation-form .star{
    color: #4FA800;}
#page #detail-reservation-form .not-mandatory{
	color: #4FA800;
    display: block;
    font-size:8pt;}
...
#page #detail-reservation-form #reservation_save{
	...
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/send_offer.png");
	width:623px;
	height:44px;
	margin: 20px 0px 0px 0px;
	cursor: pointer;
}
#page #detail-reservation-form #detail-feedback {
	width:550px;
}
...
#search-external-advertising h3 {
	color: #FFFFFF;
	font-family: Arial;
	font-size: 17pt;
	font-weight: bold;
...
#search-external-advertising .hotels-reservation{
	color: #FFFFFF;
	font-family: Arial;
	font-size: 10pt;
	font-weight: bold;
...
#page #detail-reservation-form #feedback_save{
	text-indent:-9999px;
 	border-style: none;
	background:url("'; ?>
<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/send_feedback.png");
	width:142px;
	height:44px;
	margin: 20px 0px 0px 0px;
	cursor: pointer;
...
#page #detail-reservation-form .reservation .footer{
	text-align:center;
}
.clear-background {
	background-color:#22246a;}
...
table.prices td { padding:2px; border:1px solid #8EB8E1; }
table.prices td.right { text-align:right; }
table.prices td.header { height:23px;} 
...
table.detail td.price{ color:#8EB8E1;}
/*MENU CONTINENTS START*/
.country-list {display:none;position:absolute;height:545px;left:300px;top:0px;color:#fff;}	
.country-list ul{padding:8px 15px;margin-top:3px;vertical-align:top;float:left;background-color:#22246a;}
.country-list ul.second{padding:8px 15px 8px 0;top:-514px;left:195px;position:relative}
.country-list ul.third{padding:8px 15px 8px 0;top:-1027px;left:375px;position:relative}
.country-list ul li.country {color: #FFFFFF;font-size: 9pt;width:155px;height:26px;background-color:#2b2d70;border-style:solid;border-width:1px 1px 1px 1px;border-color:#22246a;margin-top:5px;padding-left:10px;line-height:20px;}
.country-list ul li.country:hover {border-left-color:#4e5088;border-top-color:#4e5088;border-bottom-color:#4e5088;font-weight:bold;color:#ffcb08;}
#europe:hover  #country-list-europe{display:block;}
#africa:hover  #country-list-africa{display:block;}
#asia:hover  #country-list-asia{display:block;}
#america:hover  #country-list-america{display:block;}
#australia:hover  #country-list-australia{display:block;}
.towns-list {display:none;position:relative;left:155px;top:-24px;z-index:9994;color:#fff;}
.towns-list-visible {display:block;}
.towns-list ul{position:absolute;padding:0;margin-top:3px;vertical-align:top;float:left;}
.towns-list ul  a{
    color: #FFFFFF;
    font-size: 9pt;
    font-weight: bold;}
.towns-list ul li.town:first-child {border-top-width:1px;border-right-width:1px;border-bottom-width:0px;border-left-color:#2b2d70;border-top-color:#4e5088;border-right-color:#4e5088;border-bottom-color:#4e5088;padding-top:3px;}
.towns-list ul li.town:last-child {border-bottom-width:1px;border-bottom-color:#4e5088;}
.towns-list ul li.town {border-style:solid;border-width:0px 1px 1px 1px;border-color:#4e5088;border-bottom-color:#2b2d70;vertical-align:top;width:155px;height:23px;background-color:#2b2d70;margin-top:0px;padding-left:10px;line-height:10px;overflow:hidden;}
.towns-list ul a:hover {color:#ffcb08;}
/*MENU CONTINENTS END*/
...
#footer #footer-info #footer-info-top { 
	...
	float:left;
	text-align:center; }
#footer #footer-info #footer-info-top ul {
	margin: 0 auto;
	display:inline-block; }
#footer #footer-info #footer-info-top li.first {
	/*margin:2px 0px 0px 270px;*/ }
#footer #footer-info #footer-info-top li {
	position:relative; 
	...
	font-weight:normal; 
	line-height:35px; }
#footer #footer-info #footer-info-top li:hover {
	color:#4fa800; }
#footer #footer-info #footer-info-top li.selected {
	color:#4fa800; }
