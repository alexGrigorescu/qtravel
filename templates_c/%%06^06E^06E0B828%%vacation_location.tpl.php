<?php /* Smarty version 2.6.18, created on 2011-09-27 09:41:53
         compiled from /home/qtravel/public_html/templates/default/vacation_location.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', '/home/qtravel/public_html/templates/default/vacation_location.tpl', 3, false),array('function', 'tr', '/home/qtravel/public_html/templates/default/vacation_location.tpl', 9, false),array('modifier', 'nl2br', '/home/qtravel/public_html/templates/default/vacation_location.tpl', 107, false),array('modifier', 'escape', '/home/qtravel/public_html/templates/default/vacation_location.tpl', 118, false),array('modifier', 'strip_tags', '/home/qtravel/public_html/templates/default/vacation_location.tpl', 137, false),array('modifier', 'truncate', '/home/qtravel/public_html/templates/default/vacation_location.tpl', 137, false),)), $this); ?>
<div style="">
	<div class="accnav">
...
"><?php echo $this->_tpl_vars['tr']['layout_type']; ?>
		...
		<a href="<?php echo smarty_function_url(array('o' => $this->_tpl_vars['type'],'m' => 'continent','continent' => $this->_tpl_vars['location']['continent_code']), $this);?>
"><?php echo $this->_tpl_vars['location']['continent_title']; ?>
</a>  &raquo; 
		<a href="<?php echo smarty_function_url(array('o' => $this->_tpl_vars['type'],'m' => 'country','country' => $this->_tpl_vars['location']['country_code']), $this);?>
"><?php echo $this->_tpl_vars['location']['country_title']; ?>
</a>  &raquo; 
		<a href="<?php echo smarty_function_url(array('o' => $this->_tpl_vars['type'],'m' => 'region','region' => $this->_tpl_vars['location']['region_code']), $this);?>
"><?php echo $this->_tpl_vars['location']['region_title']; ?>
</a>
	</div>
	<h3 class="acch3"><?php echo smarty_function_tr(array('key' => 'vacation_title_vacation'), $this);?>
...
"/></div>					
			<div><span class="price"><?php echo smarty_function_tr(array('key' => 'vacation_price'), $this);?>
 <?php echo $this->_tpl_vars['location']['price']; ?>
 <?php echo $this->_tpl_vars['location']['currency_title']; ?>
</span></div>													
		</div>
		<div style="float:right" class="reservation"><a href="<?php echo smarty_function_url(array('o' => 'reservation','m' => 'index','type' => $this->_tpl_vars['type'],'id' => $this->_tpl_vars['location']['id']), $this);?>
"><?php echo $this->_tpl_vars['tr']['type_reservation']; ?>
...
" title="" rel="item-gal"><?php echo $this->_tpl_vars['pic']['thumb']; ?>
	...
	<h3 class="acch3"><?php echo smarty_function_tr(array('key' => 'vacation_title_prices'), $this);?>
 <b style="color:#ff0000;"><?php echo $this->_tpl_vars['location']['title']; ?>
</b>, <?php echo $this->_tpl_vars['location']['region_title']; ?>
, <?php echo $this->_tpl_vars['location']['country_title']; ?>
, <?php echo $this->_tpl_vars['location']['continent_title']; ?>
...
?>
	...
	* Preturile sunt exprimate in 
	...
	<?php if ($this->_tpl_vars['locations_count'] > 1): ?>
		<div>
			<h3 class="acch3"><?php echo smarty_function_tr(array('key' => 'vacation_title_other_vacations'), $this);?>
 <?php echo $this->_tpl_vars['location']['region_title']; ?>
, <?php echo $this->_tpl_vars['location']['country_title']; ?>
, <?php echo $this->_tpl_vars['location']['continent_title']; ?>
</h3>
...
?>
			...
			<div class="acc" style="width:100%;">
				<div class="acctitle">
					<div style="float:left; height:16px;"><a href="<?php echo smarty_function_url(array('o' => $this->_tpl_vars['type'],'m' => 'location','location' => $this->_tpl_vars['new_location']['code'],'country' => $this->_tpl_vars['new_location']['country_code']), $this);?>
...
"><?php echo $this->_tpl_vars['new_location']['title']; ?>
				...
				<div class="accbodyreg" style="height:115px;">
					<div style="float:left;width:110px; text-align:center; padding-top:5px;">
						<div class="accthumb"><a href="<?php echo smarty_function_url(array('o' => $this->_tpl_vars['type'],'m' => 'location','location' => $this->_tpl_vars['new_location']['code'],'country' => $this->_tpl_vars['new_location']['country_code']), $this);?>
" title="<?php echo $this->_tpl_vars['new_location']['title']; ?>
