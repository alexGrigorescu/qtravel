<?php /* Smarty version 2.6.18, created on 2013-02-07 17:34:05
         compiled from /home/qtravel/public_html/systems/oferta-vacanta/templates/member/ajax_vacancy_detail_tarif7.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substr', '/home/qtravel/public_html/systems/oferta-vacanta/templates/member/ajax_vacancy_detail_tarif7.tpl', 38, false),array('modifier', 'strlen', '/home/qtravel/public_html/systems/oferta-vacanta/templates/member/ajax_vacancy_detail_tarif7.tpl', 83, false),)), $this); ?>
<?php $_from = $this->_tpl_vars['priceImages7Night']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
?>
			<tr>
				...
				<?php if ($this->_tpl_vars['price_single']): ?><td class="right"><?php echo $this->_tpl_vars['new_price']['night7']['price_single_format']; ?>
</td><?php endif; ?>
				<?php if ($this->_tpl_vars['price_double']): ?><td class="right"><?php echo $this->_tpl_vars['new_price']['night7']['price_double_format']; ?>
</td><?php endif; ?>
				<?php if ($this->_tpl_vars['price_3adult']): ?><td class="right"><?php echo $this->_tpl_vars['new_price']['night7']['price_3adult_format']; ?>
</td><?php endif; ?>
				<?php if ($this->_tpl_vars['price_triple']): ?><td class="right"><?php echo $this->_tpl_vars['new_price']['night7']['price_triple_format']; ?>
</td><?php endif; ?>
				<?php if ($this->_tpl_vars['price_1child']): ?><td class="right"><?php echo $this->_tpl_vars['new_price']['night7']['price_1child_format']; ?>
</td><?php endif; ?>
				<?php if ($this->_tpl_vars['price_2child']): ?><td class="right"><?php echo $this->_tpl_vars['new_price']['night7']['price_2child_format']; ?>
</td><?php endif; ?>
				<?php if ($this->_tpl_vars['price_extra1']): ?><td class="right"><?php echo $this->_tpl_vars['new_price']['night7']['price_extra1_format']; ?>
</td><?php endif; ?>
				<?php if ($this->_tpl_vars['price_extra2']): ?><td class="right"><?php echo $this->_tpl_vars['new_price']['night7']['price_extra2_format']; ?>
</td><?php endif; ?>
				<?php if ($this->_tpl_vars['price_extra3']): ?><td class="right"><?php echo $this->_tpl_vars['new_price']['night7']['price_extra3_format']; ?>
</td><?php endif; ?>
			</td>
		<?php endforeach; endif; unset($_from); ?>
		</table>
...
<?php else: ?>
	euro (&euro;)
<?php endif; ?> si sunt calculate pe o perioada de 7 zile
</span><br /><br />	
