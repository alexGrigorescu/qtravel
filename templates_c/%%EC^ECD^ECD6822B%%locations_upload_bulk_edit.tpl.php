<?php /* Smarty version 2.6.18, created on 2009-07-12 23:48:41
         compiled from /home/qtravel/public_html/templates/default/locations_upload_bulk_edit.tpl */ ?>
...
<?php echo '
	...
	if (_ie == true) {
	  ...
	  document.write(\'url="'; ?>
<?php echo $this->_tpl_vars['upload_bulk_url']; ?>
<?php echo '" \');
...
<?php echo $this->_tpl_vars['upload_thanks_url']; ?>
<?php echo '" \');
...
<?php echo '">\');
	...
	var thanks = '; ?>
<?php if ($this->_tpl_vars['thanks']): ?>true<?php else: ?>false<?php endif; ?><?php echo ';
	var id = '; ?>
