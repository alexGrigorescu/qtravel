<?php /* Smarty version 2.6.18, created on 2013-02-07 17:26:47
         compiled from /home/qtravel/public_html/systems/oferta-vacanta/templates/member/buss_location.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', '/home/qtravel/public_html/systems/oferta-vacanta/templates/member/buss_location.tpl', 6, false),array('modifier', 'count', '/home/qtravel/public_html/systems/oferta-vacanta/templates/member/buss_location.tpl', 116, false),)), $this); ?>
<?php echo '
<div id="page">
...
<?php echo $this->_tpl_vars['offer']; ?>
 ...
 | <span itemprop="addressCountry"><?php echo $this->_tpl_vars['location']['end_country_title']; ?>
						...
						<div class="right">
							<a rel="nofollow" href="'; ?>
<?php echo smarty_function_url(array('o' => 'reservation','m' => 'index','type' => 'busses','id' => $this->_tpl_vars['location']['id']), $this);?>
"><img src="<?php echo $this->_tpl_vars['img_path']; ?>
<?php echo '/detail_btn_get_offer.png"></a>
						</div>
					</div>
					'; ?>
<div id="detail-buss-pictures">
						<table>
							<tr>
								<td><span class="description-text-block">Pret Dus: </span></td>
								<td><span class="description-text-block"><?php echo $this->_tpl_vars['location']['price1']; ?>
 <?php echo $this->_tpl_vars['location']['currency_title']; ?>
</span></td>
							</tr>
							<tr>
								<td><span class="description-text-block">Pret Dus - Intors: </span></td>
								<td><span class="description-text-block"><?php echo $this->_tpl_vars['location']['price2']; ?>
 <?php echo $this->_tpl_vars['location']['currency_title']; ?>
</span></td>
							</tr>
						</table>
...
/similar_back.png"></a>
					<?php endif; ?>
					<a rel="nofollow" href="<?php echo smarty_function_url(array('o' => 'buss','m' => 'region','region' => $this->_tpl_vars['location']['end_region_code']), $this);?>
"><img src="<?php echo $this->_tpl_vars['img_path']; ?>
	...
	$(function(){
		...
		$( "#detail-btn-details" ).click(function() {
			api.getContentPane().load(
						\''; ?>
<?php echo smarty_function_url(array('o' => 'buss','m' => 'location'), $this);?>
