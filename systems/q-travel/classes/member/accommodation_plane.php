<?php
	class accommodation_plane
	{
		function index()
		{
			...
			$set = array('special1'=>'1', 'page_size'=>$pageSize, 'page'=>$page, 'sorting'=>' accommodations.special2 desc, accommodation_type_stars asc, accommodations.price asc','price_min'=>1, 'transport'=>1, 'continent_id'=>implode(',',$continentValidIds));
