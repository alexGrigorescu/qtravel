...
<h1 class="title">{$meta.title}</h1>
	<div id="page">
		<div id="header">
			...
			<div class="header-contact header-contact-{$header}">
		...
		<div class="regiuni">
			...
			<ul>
				{foreach from=$GLOBALS.ACCOMCAT_ACTIVE item=acc key=acc_code}
					<li><div class="divli"><a href="/{$acc_code}.html" title="{$acc}">{$acc}</a></div></li>
				{/foreach}
		...
		{if $meta.widthLeftBox}
			...
			<div class="newsletter">
				...
				<div class="newsletter-button"><input type="image" src="{$img_path}newsletter-trimite.png" onClick="newsletter();"/></div>                	
				<script language="javascript">
					{literal}
					function newsletter()
							{
								var url = "{/literal}{url o='newsletter' m ='save'}{literal}";
				...
				{*{if $layout_domain.code == 'oferta-vacanta'}<div class="vacanta"><a href="http://www.oferta-vacanta.ro/" title="Oferta vacanta"><img src="{$img_path}vacanta2009.jpg" style="width:227px; height:331px; border:0px;" alt="Oferta vacanta"/></a></div>{/if}*}
