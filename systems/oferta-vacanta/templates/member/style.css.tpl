...
body { 
	...
	text-align:center; 
	width:100%;  
	background:url("{/literal}{$img_path}{literal}/bg.png") repeat-x ; 
...
#page #page-body #body-engine-full{
	...
	width:975px;
	float:left;
	background: url({/literal}{$img_path}{literal}/result_bg_full.png) no-repeat;
	background-color:#22246a; }
#page #page-body #body-engine-full-height{
	margin:0px 0px 0px 0px;
	width:675px;
	float:left;
	background: url({/literal}{$img_path}{literal}/result_bg_full.png)repeat-y;
	background-color:#22246a; }
...
#page #promo-container #promo-header li.ski-inactive { 
	width: 40px;		
	height:29px;		
	background:url("{/literal}{$img_path}{literal}/btn_promo_ski.png"); }
#page #promo-container #promo-header li.ski-active { 
	width: 40px;		
	height:29px;		
	background:url("{/literal}{$img_path}{literal}/btn_promo_ski_h.png"); }
...
#page #promo-container #promo-header li.noel-inactive { 
	width: 79px;		
	height:29px;		
	background:url("{/literal}{$img_path}{literal}/btn_promo_noel.png"); }
#page #promo-container #promo-header li.noel-active { 
	width: 79px;		
	height:29px;		
	background:url("{/literal}{$img_path}{literal}/btn_promo_noel_h.png"); }
...
#page #promo-container #promo-header li.new_year_eve-inactive { 
	width: 85px;		
	height:29px;		
	background:url("{/literal}{$img_path}{literal}/btn_promo_new_year_eve.png"); }
#page #promo-container #promo-header li.new_year_eve-active { 
	width: 85px;		
	height:29px;		
	background:url("{/literal}{$img_path}{literal}/btn_promo_new_year_eve_h.png"); }
...
#page #promo-container #promo-header li.spa_balneo-inactive { 
	width: 106px;		
	height:29px;		
	background:url("{/literal}{$img_path}{literal}/btn_promo_spa_balneo.png"); }
#page #promo-container #promo-header li.spa_balneo-active { 
	width: 106px;		
	height:29px;		
	background:url("{/literal}{$img_path}{literal}/btn_promo_spa_balneo_h.png"); }
...
#promo-accordion #promo-body #promo-offers li {
	...
	width:174px;
	height:292px;
	background:url("{/literal}{$img_path}{literal}/promo_accordion_item_bg.png"); }
...
#page #continents-buttons li.continent:hover {
	background:url("{/literal}{$img_path}{literal}/btn_continent_s.png"); } 
...
#page #detail-reservation-form #feedback_save{
	text-indent:-9999px;
 	border-style: none;
	background:url("{/literal}{$img_path}{literal}/send_feedback.png");
	width:142px;
	height:44px;
	margin: 20px 0px 0px 0px;
	cursor: pointer;
